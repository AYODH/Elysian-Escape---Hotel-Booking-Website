...
if (isset($_POST['book'])) {
    ...
    if ($verify_bookings->rowCount() > 0) {
        $warning_msg[] = 'Already booked this room!';
    } else {
...
if (isset($_POST['send'])) {
    ...
    if ($verify_message->rowCount() > 0) {
        $warning_msg[] = 'Already sent this message!';
    } else {
...
<body>
    ...
    <section class="about" id="about">
        ...
        <div class="row">
            ...
            <div class="content">
                <h3>Best staff</h3>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Animi laborum maxime eius aliquid temporibus
                    unde?</p>
                <a href="#reservation" class="btn">make a reservation</a>
            </div>
            ...
            <div class="row revers">
                ...
                <div class="content">
                    <h3>Best foods</h3>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Animi laborum maxime eius aliquid
                        temporibus
                        unde?</p>
                    <a href="#contact" class="btn">contact us</a>
                </div>
        ...
        <div class="row">
            ...
            <div class="faq">
                ...
                <div class="box active">
                    <h3>How to cancel?</h3>
                    <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Voluptatibus iste placeat dolor
                        corrupti sed. Repudiandae.</p>
                </div>
        ...
        <div class="swiper reviews-slider">
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide box">
                    ...
                    <h3>John Deo</h3>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sunt explicabo minima, sint sequi optio
                        nemo.</p>
                </div>
